class Aventura {
  ...
  cargarPantallas(lineas) {
    ...
    this.pantallas[1] = new PantallaUnBoton(imgs[1], 300, 360, 2, "Siguiente", 60, lineas[0], lineas[1], lineas[2]);
    this.pantallas[2] = new PantallaDosBotones(imgs[2], 255, 350, 345, 350, 3, 4, "Abandonar", "Rescatar", 280, lineas[3], lineas[4], lineas[5]);
    this.pantallas[3] = new PantallaUnBoton(imgs[11], 300, 350, 0, "Reintentar", 60, lineas[6], lineas[7], lineas[8]);//primer final
